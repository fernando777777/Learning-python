'''El desarrollador Edwin Fernando Bacca Montenegro
ha creado un script para configurar una base
 de datos SQLite llamada "School".
'''
import sqlite3
...
'''creamos múltiples tablas en una base de datos, cada una diseñada para almacenar información específica sobre países, departamentos, 
ciudades, personas, usuarios, tipos de identificación y estudiantes, y establece relaciones entre ellas mediante claves externas. 
Una vez que se crean las tablas, se imprime un mensaje indicando que la base de datos ha sido creada.'''
