...
def create_country(op):
    ...
    os.system('pause')
    menu()
'''consulta una base de datos para obtener una lista de países con sus respectivos IDs y nombres, y luego imprime esta 
    información en la pantalla. Además, borra la pantalla antes de imprimir la lista de países'''
...
'''solicita al usuario información sobre un nuevo departamento, la inserta en
 una base de datos y luego muestra un mensaje de éxito antes de volver al menú principal del programa.'''
